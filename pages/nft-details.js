  ...
  <div className="flex flex-col">
    ...
    <div className="flexBetweenStart my-5">
      <div className="flex-1 flexStartCenter">
        ...
        <div className="flecCenterStart flex-col ml-5">
      ...
      <div>
        <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-sm minlg:text-xl"><span className="font-semibold"> {nft.price}</span>{nftCurrency}</p>
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      <div className="relative flex-1 flexCenter sm:px-4 p-12 border-r md:border-r-0 md:border-b dark:border-nft-black-1 border-nft-gray-1 ">
        <div className="relative w-557 minmd:w-2/3 minmd:h-2/3 sm:w-full sm:h-300 h-557"><Image src={nft.image} objectFit="cover" className="rounded-xl shadow-lg" layout="fill" /></div>
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-row items-center mt-3">
            <div className="relative w-12 h-12 minlg:w-20 minlg:h-20 mr-2">
              <Image src={images.creator} objectFit="cover" className="rounded-full" layout="fill" />
            </div>
          ...
          {currentAccount === nft.seller.toLowerCase() ? (
            ...
            ? (
              <Button
                ...
                handleClick={() => router.push(`/resell-nft?tokenId={nft.tokenId}&toeknURI=${nft.tokenURI}`)}
              />
            ) : (
