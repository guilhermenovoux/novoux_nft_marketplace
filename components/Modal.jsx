...
const Modal = ({ header, body, footer, handleClose }) => {
  ...
  return (
    <div className="flexCenter fixed inset-0 z-10 bg-overlay-black animated fadeIn" onClick={handleClickOutside}>
      <div ref={modalRef} className="w-2/5 md:w-11/12 minlg:w-2/4     bg-white dark:bg-nft-black-2 flex flex-col rounded-lg">
        ...
        <div className="p-10 xm:px-4 border-t border-b dark:border-nft-black-3 border-nft-gray-1">
          {body}
        </div>
